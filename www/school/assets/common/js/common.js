...
window.config={
	...
	basePath:'http://192.168.1.99:9146/portal/',                //99服务器 接口
...
window.menuPer={
	...
	list:[
		...
		{id:101400,name:'班别管理',icon:'ion-android-list',src:'no-con/no-content-03.html'},
		...
		{id:101300,name:'驾校管理',icon:'ion-model-s',src:'no-con/no-content-06.html'},
...
window.studentStatesListForSchool=[
	{name:'报名相关',id:1,list:['5,1','6,100','7,1','7,101','7,100']},
